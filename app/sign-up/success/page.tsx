  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-neutral-900 to-black flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        {/* Success Card */}
        <div className="bg-neutral-900 rounded-lg p-8 md:p-10 text-center">
          ...
          <p className="text-neutral-400 mb-8">
            {"We've sent you a confirmation email. Please click the link in the email to verify your account and start using Spotify."}
          </p>

          <Link
            href="/"
            className="inline-block w-full py-3 px-4 bg-[#1DB954] hover:bg-[#1ed760] text-black font-bold rounded-full transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
            Back to Login
          </Link>
